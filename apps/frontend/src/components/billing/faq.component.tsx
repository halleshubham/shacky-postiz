  ...
  return [
      ...
      ? [
          {
            title: t(
              ...
              'Am I going to be charged by Shacky Postiz?'
            ),
            description: t(
              'faq_to_confirm_credit_card_information_postiz_will_hold',
              'To confirm your UPI Autopay mandate, a ₹5 charge is collected and refunded immediately, you can cancel your subscription anytime from settings without talking to a person'
            ),
          },
        ]
      : []),
    {
      title: t(
        ...
        `Can I trust ${isGeneral ? 'Shacky Postiz' : 'Gitroom'}?`
      ),
      description: t(
        'faq_postiz_gitroom_is_proudly_open_source',
        `${
          isGeneral ? 'Shacky Postiz' : 'Gitroom'
